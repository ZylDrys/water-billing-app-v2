...
export const History = (() => {
        ...
        container.innerHTML = bills.map(bill => {
            ...
            <div style="padding:15px;border:1px solid #eee;margin:10px 0;border-radius:8px;">
                ...
                <div style="margin-top:10px;">
                    <button onclick="Billing.printBillById(${bill.id})" style="padding:5px 10px;font-size:12px;">
                        🖨️ Print
                    </button>

                    <button onclick="Billing.deleteBill(${bill.id}); History.refresh('${containerId}')"
                        style="padding:5px 10px;font-size:12px;background:#dc3545;color:white;">
                        🗑️ Delete
                    </button>
                </div>
            </div>
    ...
    function refresh(containerId = "historyList") {
